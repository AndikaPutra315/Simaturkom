                    ...
                    <div class="card-body">
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="kode" name="kode" value="{{ old('kode', $dataBakti->kode) }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="latitude" name="latitude" value="{{ old('latitude', $dataBakti->latitude) }}" placeholder="-2.12345678">
                            </div>

                            {{-- Kolom Longitude --}}
                            <div class="col-md-6">
                                <label for="longitude" class="form-label">Longitude</label>
                                <input type="text" class="form-control" id="longitude" name="longitude" value="{{ old('longitude', $dataBakti->longitude) }}" placeholder="115.12345678">
                            </div>
