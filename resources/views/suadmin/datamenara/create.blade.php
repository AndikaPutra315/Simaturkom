    ...
    <main class="container mt-5">
        <div class="card shadow-sm">
            <div class="card-header">
                <h3 class="mb-0">Tambah Data Menara Baru</h3>
            </div>
            <div class="card-body">
                        ...
                        <div class="col-md-6">
                         ...
                         <div class="col-md-4">
                            ...
                            <select class="form-select @error('tipe_ukuran') is-invalid @enderror" id="tipe_ukuran" name="tipe_ukuran" required>
                                ...
                                <option value="makrocell" {{ old('tipe_ukuran') == 'makrocell' ? 'selected' : '' }}>Makrocell</option>
                                <option value="mikrocell" {{ old('tipe_ukuran') == 'mikrocell' ? 'selected' : '' }}>Mikrocell</option>
                            </select>
